...
export const proxies = pgTable("proxies", {
  ...
  bio: text("bio"),
  ensName: varchar("ens_name", { length: 255 }).unique(),
  ensNode: varchar("ens_node", { length: 66 }),
  ensOwnerAddress: varchar("ens_owner_address", { length: 42 }),
  ensResolvedAddress: varchar("ens_resolved_address", { length: 42 }),
  ensAvatarUrl: text("ens_avatar_url"),
  ensDescription: text("ens_description"),
  ensTextRecords: jsonb("ens_text_records"),
  ensRegistrationStatus: varchar("ens_registration_status", { length: 24 }),
  ensVerifiedAt: timestamp("ens_verified_at"),
  ...
  index("idx_proxies_ens_name").on(t.ensName),
