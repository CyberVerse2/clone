...
export function PortfolioSection() {
  ...
  return (
    <div className="space-y-6 rounded-2xl border border-white/8 bg-[radial-gradient(circle_at_20%_0%,rgba(55,242,255,0.14),transparent_34%),radial-gradient(circle_at_84%_12%,rgba(255,92,122,0.12),transparent_32%),rgba(255,255,255,0.025)] p-5">
          ...
          {TIME_RANGES.map((r) => (
            <button
              ...
              className={cn(
                ...
                range === r
                  ? "bg-cyan-300/15 text-white shadow-[0_0_18px_rgba(55,242,255,0.16)]"
      ...
      {/* Sparkline chart */}
      <Sparkline data={sparklineData} height={88} color="#37f2ff" />

      <div className="h-px bg-gradient-to-r from-cyan-300/35 via-coral/35 to-transparent" />
