...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    ...
    bio: proxy.bio,
    ensName: proxy.ensName,
    ensRegistrationStatus: proxy.ensRegistrationStatus,
    ensResolvedAddress: proxy.ensResolvedAddress,
    ensAvatarUrl: proxy.ensAvatarUrl,
    ensDescription: proxy.ensDescription,
    ensTextRecords: proxy.ensTextRecords,
