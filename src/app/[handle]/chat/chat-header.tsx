    ...
    >
      ...
      {ensName && (
        <Link
          ...
          className="mt-1 inline-flex items-center gap-1 rounded-full bg-lime/10 px-2 py-0.5 text-[11px] font-semibold text-lime no-underline"
        >
          <Globe2 size={11} /> {ensName}
        </Link>
      )}
      {bio && (
