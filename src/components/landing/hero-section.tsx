    ...
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-36 pb-20 relative">
      ...
      <div
        ...
        style={{
          ...
          background:
            'radial-gradient(circle, rgba(55,242,255,0.14) 0%, rgba(167,139,250,0.08) 46%, rgba(255,92,122,0.05) 62%, transparent 72%)',
        }}
      />
      ...
      >
        ...
        <span className="text-lime relative inline-block">
          Earn Forever.
          <span className="absolute bottom-1 left-0 right-0 h-1.5 bg-linear-to-r from-lime/35 to-coral/35 rounded-sm" />
        </span>
      </h1>
      ...
      >
        Spin up an AI version of yourself that people can chat with, collect,
        and support. Each clone gets a Base token — you earn {CREATOR_FEE_PERCENT}% of fees forever.
      </p>
