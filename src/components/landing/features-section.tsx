...
const FEATURES: FeatureItem[] = [
  ...
  {
    icon: Gem,
    title: 'Clone Tokenomics',
    desc: `Each clone gets its own tradeable token launched on Base. Creators earn ${CREATOR_FEE_PERCENT}% of all fees — your clone is literally an asset.`,
    visual: 'token',
    layout: 'vertical',
  ...
  },
  {
    ...
    desc: 'Upload documents, notes, or chat directly with your clone to teach it things only you know.',
    visual: 'upload',
  ...
  },
  {
    icon: Globe,
    title: 'Open Chat',
    desc: 'Anyone can discover and chat with any clone on the platform, no login required.',
    visual: 'chat',
    layout: 'horizontal',
    ...
    <div className="w-full h-full bg-lime rounded-2xl relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-5 -translate-y-1/2 bg-dark/90 rounded-lg px-3 py-2 shadow-lg flex items-center gap-2">
        ...
        <span className="text-white text-[11px] font-medium leading-tight">
          +{CREATOR_FEE_PERCENT}% clone<br />revenue
        </span>
      </div>
