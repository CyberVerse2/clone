...
const navItems = [
  ...
  { href: "/admin/proxies", icon: Bot, label: "Clones" },
    ...
    >
      ...
      <div className="h-14 px-4 flex items-center justify-between border-b border-white/6">
        <div className="flex items-center gap-2">
          {collapsed ? (
            <Image src="/clone-mark.png" alt="clone" width={24} height={24} className="shrink-0" />
          ) : (
            <>
              <Image src="/clone-logo.png" alt="clone" width={116} height={34} className="shrink-0" />
