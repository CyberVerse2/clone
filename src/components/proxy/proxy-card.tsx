...
import { BadgeCheck, Globe2, Star } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Top Clone Badge - only show for top clones by chat count */}
      ...
      >
        ...
        {proxy.ensName && (
          <div className="mb-2 flex items-center gap-1.5 text-lime text-xs font-semibold">
            <Globe2 size={13} />
            <span className="truncate max-w-full">{proxy.ensName}</span>
          </div>
        )}
