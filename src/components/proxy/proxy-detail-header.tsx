...
import { BadgeCheck, Copy, Crown, ExternalLink, Globe2, Star } from 'lucide-react';
      ...
      <div className="flex gap-5 items-start">
        ...
        <div className="space-y-2.5 min-w-0">
          ...
          <p className="text-gray text-base leading-relaxed">
            {bio ?? 'AI clone powered by clone. Chat with this digital twin.'}
          </p>
          ...
          <div className="flex items-center gap-2 pt-0.5">
            {ensName && (
              <a
                ...
                className="flex items-center gap-1.5 bg-lime/10 border border-lime/20 rounded-lg px-3.5 py-2 text-sm text-lime hover:text-white transition-colors no-underline"
                title={ensResolvedAddress ? `Resolves to ${ensResolvedAddress}` : undefined}
              >
                <Globe2 size={14} />
                <span>{ensName}</span>
