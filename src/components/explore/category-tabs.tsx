...
const SPECIAL_CATEGORIES: CategoryItem[] = [
  { id: "all", label: "All Clones", icon: LayoutGrid },
  { id: "top", label: "Top Clones", icon: Flame },
...
interface TabSectionProps {
  ...
  showSeeAll?: boolean;
  seeAllHref?: string;
  /** Subtitle for the active category (e.g. "Featured Clones") */
...
export function TabSection({
  ...
  showSeeAll = false,
  seeAllHref,
  seeAllSubtitle = "Featured Clones",
  variant = "default",
  categories,
}: TabSectionProps) {
